...
public class VisualSorting {
	...
	private String[] algorithms = { "Selection Sort", "Bubble Sort", "Cocktail Sort", "Odd Even Sort", "Insertion Sort",
			"Tim Sort", "Quick Sort", "Heap Sort", "Merge Sort", "Pigeonhole Sort", "Radix Sort(MSB)" };
	...
	public void initialize() {
		...
		jf = new JFrame();
		jf.setSize(1200, 800);
		jf.setTitle("Sorting Algorithm Visulation");
		jf.setVisible(true);
		jf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		jf.setResizable(false);
		jf.setLocationRelativeTo(null);
		jf.getContentPane().setLayout(null);
		jf.getBaselineResizeBehavior();
		// SET UP TOOLBAR
		tools.setLayout(null);
		tools.setBounds(5, 10, 200, 1000);
		...
		canvas.setBounds(220, 10, 900, SIZE - 50);
